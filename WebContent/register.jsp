...
<label for="password"><b>Contraseña</b></label><span id="error-password" class="error-msg"></span>
<input class="validate" name="password" type="password"  id="password" aria-required="true"/>
<label for="password2"><b>Confirmar Contraseña</b></label><span id="error-password2" class="error-msg"></span>
